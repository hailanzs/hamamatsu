...
HD_PWD='C:/Users/cakfi/ham/hamamatsu/SPI_TEST/SPI_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPIe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPIe.tcl -notrace
