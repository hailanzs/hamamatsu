...
HD_PWD='C:/Users/cakfi/ham/hamamatsu/SPI_TEST/SPI_TEST.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPIe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPIe.tcl
